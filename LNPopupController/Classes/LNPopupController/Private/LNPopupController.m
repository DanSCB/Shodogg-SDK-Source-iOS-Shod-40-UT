	...
	if(_popupControllerState == LNPopupPresentationStateClosed)
	{
		...
		[UIView performWithoutAnimation:^{
			...
			if(CGColorGetAlpha(contentController.view.backgroundColor.CGColor) < 1.0)
			{
                ...
                //MARK: AK - Commenting next line casuing double blur in the overlay
...
- (LNPopupContentView *)popupContentView
{
    ...
    //MARK: AK - Disabling close button
    _popupContentView.popupCloseButton.hidden = YES;
    _popupContentView.popupCloseButton.enabled = NO;
